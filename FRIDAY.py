...
def play_song(command):
    if 'trending movie' in command:
        video_url = "https://www.youtube.com/watch?v=Po3jStA673E&pp=ygURbGVvIHRhbWlsIHRyYWlsZXI%3D"
        talk("Here's a trending movie recommendation for you.")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'song' in command:
            play_song(command)
        elif 'trending movie'in command:
            play_song(command)
